...
def experiment(variant):
    ...
    critic = QNetwork(obs_dim, action_dim, latent_dim, net_size)
    target_critic = QNetwork(obs_dim, action_dim, latent_dim, net_size)
    policy = GaussianPolicy(obs_dim, action_dim, latent_dim, net_size, env.action_space)
    ...
    algorithm = PEARLSoftActorCritic(
        ...
        nets=[agent, critic, target_critic],
    ...
    #     critic.load_state_dict(torch.load(os.path.join(path, 'critic.pth')))
